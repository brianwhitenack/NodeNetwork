...
{
    public class StringSelectionNode : PartCalculationViewModel
    {
        static StringSelectionNode()
        {
            Splat.Locator.CurrentMutable.Register(() => new CodeGenNodeView(), typeof(IViewFor<StringSelectionNode>));
        }
        ...
        public StringSelectionNode() : base(NodeType.Function)
        {
